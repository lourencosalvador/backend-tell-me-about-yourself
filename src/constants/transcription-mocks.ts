const transcriptionsMock = [
    ...
    { text: "Ajudei um amigo a configurar um servidor para hospedar um site, aprendemos sobre Linux, segurança de servidores e deploy com Docker." },
    { text: "No meu tempo livre, estudei sobre inteligência artificial e machine learning. Fiz um pequeno modelo de reconhecimento de imagens para diferenciar cães e gatos." }
];
